...
namespace Astina\TodoBundle\Controller;
...
use Astina\TodoBundle\Entity\Todo;
use Astina\TodoBundle\Form\TodoType;
...
class TodoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AstinaTodoBundle:Todo')->findAll();
     ...
     * @Method("POST")
     * @Template("AstinaTodoBundle:Todo:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AstinaTodoBundle:Todo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AstinaTodoBundle:Todo:edit.html.twig")
     */
